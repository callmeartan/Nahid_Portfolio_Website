  ...
  const educationData = [
    {
      ...
      description: "Thesis: 'Extracting Implicit Features from Hand Fidgeting in ADHD Using Machine Learning'. GPA: 4.0/4.0. Conducted advanced research on machine learning applications in behavioral signal interpretation, deep learning model optimization, and multimodal sensor data analysis.",
      skills: ["Deep Learning", "Machine Learning", "Signal Processing", "Research"],
      icon: GraduationCap,
    ...
    },
    {
      ...
      title: "PhD in Computer Engineering (Transferred)",
      institution: "Istanbul Technical University",
      location: "Istanbul, Turkey",
      description: "Transferred to UCSC. Conducted research on decision-making algorithms for Advanced Driver Assistance Systems (ADAS). Explored machine learning and computer vision innovations for next-generation mobility systems. GPA: 3.8/4.0.",
      skills: ["ADAS", "Computer Vision", "Machine Learning", "Simulation"],
      icon: GraduationCap,
    ...
    },
    {
      ...
      location: "Istanbul, Turkey",
      description: "Best Student Award. GPA: 3.94/4.0. Led software development and research initiatives within the EU-funded ISG4 project, creating AI-driven educational games for children with special needs.",
    ...
    },
    {
      ...
      description: "2nd Best Senior Student. Developed foundational expertise in computer engineering, software development, and system design.",
